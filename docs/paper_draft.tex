...
This leads to the "parking lot" problem, where expensive accelerators sit idle while users think and type, resulting in average cluster utilization of 55--60\%~\cite{Gupta2023GPUUtilization}.
...
Existing systems fail at least two of these. \sys satisfies all five.o
